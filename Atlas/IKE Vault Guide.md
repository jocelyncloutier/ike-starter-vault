...
Maps are index notes that connect related knowledge across the vault. They live in `Atlas/` and serve two purposes: they help you see what you know about a topic at a glance, and they help AI quickly understand the context around any subject.

- [[Getting Started]] — First steps after opening this vault
- [[When to Use What]] — When to use Obsidian vs Claude
## How AI Is Used
